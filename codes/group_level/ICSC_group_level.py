...
def single_run (params):
	...
	for count, individual in enumerate(individuals_list):
		...
		all_individuals_all_L_k[individual], individual_mod_matrix, individual_calc_labels = get_initial_modularizations(str(count), subjects_data[individual], max_labels, min_labels)
